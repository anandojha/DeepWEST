...
conda install -c conda-forge matplotlib scipy jupyterlab pandas tensorflow mdtraj scikit-learn seaborn pytorch openmm=7.5.0 biopandas pytorch tensorflow
