...
def prepare_1igd():
    ...
    Prepares the IGG-binding domain from streprococcal protein G 
    (1IGD) system for Molecular Dynamics (MD) simulations. The 
    function downloads the pdb structure from
    https://files.rcsb.org/download/1IGD.pdb
    and parameterizes it using General Amber Force Field
    (GAFF).

    """

    os.system("curl -O https://files.rcsb.org/download/1IGD.pdb")
    os.system("rm -rf system_inputs_1igd")
    # Removes any existing directory named system_inputs_1igd
    os.system("mkdir system_inputs_1igd")
    # Creates a directory named system_inputs_1igd
    cwd = os.getcwd()
    target_dir = cwd + "/" + "system_inputs_1igd"
    ...
    shutil.copy(cwd + "/" + "1IGD.pdb", target_dir + "/" + "1IGD.pdb")
...
def run_equilibration_1igd():
    ...
    cwd = os.getcwd()
    target_dir = cwd + "/" + "equilibration_1igd"
    os.system("rm -rf equilibration_1igd")
    os.system("mkdir equilibration_1igd")
    shutil.copy(cwd + "/" + "system_inputs_1igd" + "/" + "system_TIP4P.inpcrd", target_dir + "/" + "system_TIP4P.inpcrd")
    shutil.copy(cwd + "/" + "system_inputs_1igd" + "/" + "system_TIP4P.parm7", target_dir + "/" + "system_TIP4P.parm7")
    shutil.copy(cwd + "/" + "system_inputs_1igd" + "/" + "system_TIP4P.pdb", target_dir + "/" + "system_TIP4P.pdb")
    shutil.copy(cwd + "/" + "system_inputs_1igd" + "/" + "system_TIP4P.prmtop", target_dir + "/" + "system_TIP4P.prmtop")
    shutil.copy(cwd + "/" + "system_inputs_1igd" + "/" + "system_TIP4P.rst7", target_dir + "/" + "system_TIP4P.rst7")
    shutil.copy(cwd + "/" + "system_inputs_1igd" + "/" + "1IGD.pdb", target_dir + "/" + "1IGD.pdb")
    shutil.copy(cwd + "/" + "system_inputs_1igd" + "/" + "input_TIP4P.leap", target_dir + "/" + "input_TIP4P.leap")
    os.chdir(target_dir)
    simulated_annealing()
    npt_equilibration_1igd()
    nvt_equilibration_1igd()
    os.system("rm -rf system_TIP4P.inpcrd")
    os.system("rm -rf system_TIP4P.parm7")
    os.system("rm -rf system_TIP4P.pdb")
    os.system("rm -rf system_TIP4P.rst7")
...
def create_1igd_md():
    ...
    placed in the 1igd_md directory.

    """

    cwd = os.getcwd()
    target_dir = cwd + "/" + "1igd_md"
    os.system("rm -rf 1igd_md")
    os.system("mkdir 1igd_md")
    shutil.copy(cwd + "/" + "equilibration_1igd" + "/" + "system_nvt_output_last_frame.pdb", target_dir + "/" + "system_nvt_output_last_frame.pdb")
    os.chdir(target_dir)
...
def add_vec_inpcrd():
    ...
    cwd = os.getcwd()
    target_dir = cwd + "/" + "1igd_md"
    shutil.copy(cwd + "/" + "equilibration_1igd" + "/" + "nvt_simulation_box_vectors.pkl", target_dir + "/" + "nvt_simulation_box_vectors.pkl")
    os.chdir(target_dir)
...
def explicit_md_input_1igd(imin = 0, irest = 0, ntx = 1, nstlim = 250000000, dt = 0.002, ntc = 2, 
...
def run_1igd_md_cpu(md_input_file = "md.in", output_file = "system_final.out",
...
prepare_1igd()
run_equilibration_1igd()
create_1igd_md()
add_vec_inpcrd()
add_vec_prmtop()
explicit_md_input_1igd()
#run_1igd_md_cpu()
